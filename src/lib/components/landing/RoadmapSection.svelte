<script>
  ...
  const tasks = [
    ...
    },
    {
      id: 2,
      title: "Web App Beta",
      description: "Browser-based access to discover and manage apps",
      status: "inProgress",
      eta: "NEXT 3 MONTHS",
    },
    {
    ...
    {
      id: 4,
      title: "Zap Integration v2",
      description: "Enhanced tipping experience with splits",
      status: "inReview",
      eta: "NEXT 2 MONTHS",
    },
    {
      ...
      description: "Localization for global user base",
      status: "inReview",
      eta: "NEXT 2 MONTHS",
    },
    {
      ...
      description: "Curated lists and categories by the community",
      status: "closed",
      eta: "COMPLETED",
    },
    {
      ...
      description: "Reproducible build verification system",
      status: "closed",
      eta: "COMPLETED",
    },
  ];
