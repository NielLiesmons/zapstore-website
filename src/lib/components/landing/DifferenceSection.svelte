...
<section class="border-t border-border/50 pt-12 lg:pt-16 pb-0">
  ...
  <div class="container mx-auto px-4 sm:px-6 lg:px-8">
    <div class="comparison-table-wrapper overflow-x-auto relative">
      ...
      <div class="md:hidden absolute left-1/2 transform -translate-x-1/2 z-20" style="bottom: 24px;">
        <button
          type="button"
...
<style>
  ...
  .table-overlay-gradient {
    ...
    right: 0;
    height: 120px;
    background: linear-gradient(to top, hsl(var(--background)) 0%, hsl(var(--background) / 0.95) 25%, hsl(var(--background) / 0.7) 50%, hsl(var(--background) / 0.3) 75%, transparent 100%);
    pointer-events: none;
    z-index: 10;
  }
