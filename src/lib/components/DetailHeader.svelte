<script>
  ...
  /** @type {string|null} - Publisher profile picture URL */
  export let publisherPic = null;

  /** @type {string|null} - Publisher display name */
  export let publisherName = null;

  /** @type {string|null} - Publisher hex pubkey for fallback avatar */
  export let publisherPubkey = null;

  /** @type {string} - Link to publisher profile page */
  export let publisherUrl = "#";

  /** @type {number|null} - Creation timestamp */
  export let timestamp = null;

  /** @type {Array<{pictureUrl?: string, name?: string, pubkey?: string}>} - Catalog profiles */
  export let catalogs = [];

  /** @type {string} - Text shown with catalog stack */
  export let catalogText = "In Zapstore";

  /** @type {boolean} - Whether to show publisher info (false for profile pages) */
  export let showPublisher = true;
  ...
  function openSearch() {
    searchOpen = true;
    menuOpen = false; // Close menu when opening search
  }
