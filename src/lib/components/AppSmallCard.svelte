<script>
   ...
   * @example
   * <AppSmallCard
   *   app={{ name: "Zapstore", icon: "...", description: "...", dTag: "..." }}
   *   href="/apps/zapstore"
   * />
   */

  /** @type {{ name: string, icon?: string, description?: string, descriptionHtml?: string, dTag?: string }} */
  export let app;
  ...
  $: description =
    typeof document !== "undefined"
      ? getPlainDescription(app)
      : app.description || "";
</script>

<a {href} class="app-small-card {className}">
  <!-- Mobile icon (56px) -->
